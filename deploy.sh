...
app_name="futur-tech-zabbix-chrony"
...
sudoersd_addto_file $app_name zabbix "$(type -p chronyc) tracking"
sudoersd_addto_file $app_name zabbix "$(type -p chronyd) --version"
